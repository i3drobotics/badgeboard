...
var badges = [
	...
	},
	{
		...
		size: { x: 2, y: 1 },
		position: { x: 5, y: 8 },
		uri: corssproxy + 'https://github.com/i3drobotics/i3dr_pcl_tools-ros/workflows/ROS%20Build/badge.svg?event=push',
		title: "i3dr_pcl_tools",
		description: 'Support package for using Point Cloud Library in ROS',
		link: 'https://github.com/i3drobotics/i3dr_pcl_tools-ros',
		measure: { x: 120, y: 5 },
		colors: [['status-warning', '212,52,67'], ['status-danger', '197,105,30'], ['status-good', '49,197,83']],
	},
	{
	...
	},
	{
		...
		size: { x: 2, y: 1 },
		position: { x: 5, y: 10 },
		uri: corssproxy + 'https://github.com/i3drobotics/i3dr_kinova-ros/workflows/ROS%20Build/badge.svg?event=push',
		title: "i3dr_kinova",
		description: 'Kinova with I3DR Cameras in ROS',
		link: 'https://github.com/i3drobotics/i3dr_kinova-ros',
		measure: { x: 120, y: 5 },
		colors: [['status-warning', '212,52,67'], ['status-danger', '197,105,30'], ['status-good', '49,197,83']],
	},
	{
